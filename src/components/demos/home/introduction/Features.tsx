    ...
    return (
        <Flex gap="4rem" justify="space-between">
            <Flex direction="column" align="flex-start" gap="xs">
                ...
                <Title order={3} size="1rem" fontWeight="semiBold">Free and open source</Title>
            </Flex>
            <Flex direction="column" align="flex-start" gap="xs">
                <ActionBox radius="md" size="3rem" variant="gradient">
                    <IconBrandMantine stroke={1.3} width={35} height={35} color="white" />
                </ActionBox>
                <Title order={3} size="1rem" fontWeight="semiBold">Inspired by Mantine UI</Title>
            </Flex>
            <Flex direction="column" align="flex-start" gap="xs">
                <ActionBox radius="md" size="3rem" variant="gradient">
                    <IconBrandSass stroke={1.3} width={35} height={35} color="white" />
                </ActionBox>
                <Title order={3} size="1rem" fontWeight="semiBold">Made with styled-components</Title>
            </Flex>
        </Flex>
    )
}
